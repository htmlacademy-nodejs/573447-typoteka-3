...
const mockedArticles = [
  {
    ...
    category: [`Железо`, `Кино`, `Без рамки`],
    comments: [
      {id: `PK6Tko`, text: `Согласен с автором!`},
      {
        id: `Ehn7qH`,
      ...
      {id: `FwX6YO`, text: `Плюсую, но слишком много буквы!`},
    ],
  },
  {
    id: `8Ljh8l`,
    ...
    comments: [
      ...
      {id: `AJeD9N`, text: `Совсем немного... Это где ж такие красоты?`},
    ],
  },
  {
    id: `m_gFTf`,
    ...
    category: [`Без рамки`, `Музыка`, `За жизнь`, `Деревья`],
    comments: [
      {
        id: `x8Zzui`,
  ...
  },
  {
    ...
    category: [`IT`, `Программирование`, `Кино`, `Деревья`, `Железо`, `Музыка`],
    comments: [{id: `Nt9Vxo`, text: `Это где ж такие красоты?`}],
  },
  {
    id: `5wXLUD`,
